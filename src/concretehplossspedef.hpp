/**
 * @file concretehplossspedef.hpp
 * @author B. Le Clère, A. Perhirin
 * @since 19/10/2015
 * @brief Définition de la perte d'HP d'une unité défensive
**/

#ifndef CONCRETE_HP_LOSS_SPE_DEF_HPP
#define CONCRETE_HP_LOSS_SPE_DEF_HPP
...
/**
 * @class ConcreteConcreteHPLossSpeDef concretehplossspedef.hpp
 * 
...
#endif // CONCRETE_HP_LOSS_SPE_DEF_HPP
