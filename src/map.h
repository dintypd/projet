 ...
 */
 class Map
 {
	 ...
	 public:
		 ...
		 */
		bool isValidPath(/*Unit unit, */Path path);
		 ...
		 */
		bool isValidViewLine(/*Unit unit, */Position position);
		 ...
		 */
		/*Unit*/void getUnitAt(Position position);
		 ...
		 */
		bool isUnitAt(Position position);
		 ...
		 */
		Decor getDecorAt(Position position);
		 ...
		 */
		bool isDecorAt(Position position);
 };
